...
# we're lazy and repeating this code... don't judge
# first run of this code is to burn all of the burst credits which takes 30 minutes
base_command = 'fio --ioengine=libaio --invalidate=1 --ramp_time=5 --size=%s --runtime=1860 --time_based' % (file_size)
...
# second run is the actual benchmark
base_command = 'fio --ioengine=libaio --invalidate=1 --ramp_time=5 --size=%s --runtime=300 --time_based' % (file_size)
print('#!/usr/bin/env bash')
print('rm -rf results')
print('mkdir results')
print('cd results')
